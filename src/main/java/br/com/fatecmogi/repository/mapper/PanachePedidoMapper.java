...
@Mapper(componentModel = "cdi", uses = { PanacheCartaoCreditoMapper.class, PanacheEnderecoMapper.class,
		PanacheCartaoCreditoMapper.class, PanacheLivroMapper.class, PanacheCarrinhoMapper.class })
