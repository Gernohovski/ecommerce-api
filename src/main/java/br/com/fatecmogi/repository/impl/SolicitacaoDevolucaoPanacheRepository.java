...
public class SolicitacaoDevolucaoPanacheRepository implements SolicitacaoDevolucaoRepository {
	...
	public void save(SolicitacaoDevolucao solicitacaoDevolucao) {
		PanacheSolicitacaoDevolucao panacheSolicitacaoDevolucao = panacheSolicitacaoDevolucaoMapper
			.from(solicitacaoDevolucao);
		panacheSolicitacaoDevolucao.persistDependencies();
		panacheSolicitacaoDevolucao.persist();
	}

	@Override
	public Optional<SolicitacaoDevolucao> findByPedidoId(Long id) {
		PanacheSolicitacaoDevolucao panacheSolicitacaoDevolucao = PanacheSolicitacaoDevolucao.find("pedido.id", id)
			.firstResult();
