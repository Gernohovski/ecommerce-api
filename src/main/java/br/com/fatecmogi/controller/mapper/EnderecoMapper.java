...
public interface EnderecoMapper {
    ...
    @Mapping(target = "tipoLogradouro.id", source = "tipoLogradouroId")
    @Mapping(target = "cliente.id", source = "clienteId")
    EnderecoResidencial updateEnderecoResidencial(@MappingTarget EnderecoResidencial enderecoResidencial, EditarEnderecoClienteCommand command);
    ...
    @Mapping(target = "tipoLogradouro.id", source = "tipoLogradouroId")
    @Mapping(target = "cliente.id", source = "clienteId")
    EnderecoCobranca updateEnderecoCobranca(@MappingTarget EnderecoCobranca enderecoCobranca, EditarEnderecoClienteCommand command);
    ...
    @Mapping(target = "tipoLogradouro.id", source = "tipoLogradouroId")
    @Mapping(target = "cliente.id", source = "clienteId")
    EnderecoEntrega updateEnderecoEntrega(@MappingTarget EnderecoEntrega enderecoEntrega, EditarEnderecoClienteCommand command);
